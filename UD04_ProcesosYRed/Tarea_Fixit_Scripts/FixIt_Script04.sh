...
# FUNCION: Debe mostrar 2 mensajes al usuario, esperar 1 segundo y mostrar un tercero, contar hasta 5 y creando una carpeta en /tmp/ que se llame: /tmp/CONTADOR-ejemplo/CONTADOR"
#
# Ejemplos:
# /tmp/1-ejemplo/1/
# /tmp/2-ejemplo/2/
